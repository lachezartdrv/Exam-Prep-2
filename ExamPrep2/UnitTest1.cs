...
namespace ExamPrep2
{
    ...
    public class FoodyTests
    {
        ...
        public void Setup()
        {
            string token = GetJwtToken("lach15", "123456");
        ...
        public void CreateFood_ShouldReturnCreated()
        {
            ...
            Assert.That(createdFoodId, Is.Not.Null.And.Not.Empty, "FoodId should not be null or empty");
        }
        ...
        [Order(5)]
        [Test]
        public void CreateFood_WithoutRequiredFields_ShouldReturnRequest()
        {
            var food = new
            {
                Name = "",
